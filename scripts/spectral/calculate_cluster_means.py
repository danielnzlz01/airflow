...
upload_to_blob(cluster_means, 'cluster_means_spectral', storage_conn_str, container_name, folder='parquets')
upload_to_blob(data, 'spectral_data_cluster', storage_conn_str, container_name, folder='parquets')
