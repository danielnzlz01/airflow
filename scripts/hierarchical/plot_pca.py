...
fig = px.scatter(pca_df, x='PC1', y='PC2', color='Cluster', title='PCA of Clusters')
upload_to_blob(fig.to_html(), 'clusters_pca_hierarchical', storage_conn_str, container_name, folder='plots')
